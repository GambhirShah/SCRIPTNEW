...
import com.quadlabs.pageobject.hotel.BookingHotelTripRequest;
import com.quadlabs.pageobject.hotel.DashBoard;


public class BookingHotelTripRequestTest extends Baselibrary {
	...
	BookingHotelTripRequest.Bookonstar(i);
